    ...
    return (
        <Fragment>
            ...
            <Box my={2} display="flex" flexDirection="row" justifyContent="flex-start">
                <Box mr={1}><Link href={facebookUrl}><FacebookIcon/></Link></Box>
                <Box mr={1}><Link href={instagramUrl}><InstagramIcon/></Link></Box>
                <Box mr={1}><Link href={twitterUrl}><TwitterIcon/></Link></Box>
            </Box>
        </Fragment>
    );
}
